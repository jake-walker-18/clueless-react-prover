...
class App extends React.Component {
	...
	getProof = async () => {
		...
		const url = `'http://34.244.193.16:8080/'credentials-for-default-proof?masterSecretId=${masterSecretID}&proverWalletID=${username}&proverDID=${DID}&proof=${proofType}&proverWalletKey=${password}`
		console.log(url + '!')
		await fetch(url)
